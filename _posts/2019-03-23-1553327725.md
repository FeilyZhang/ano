# Machine Learning: Decision tree learning algorithm
...
![熵计算公式](/FeilyZhang/ano/raw/master/images/shang.png)

条件熵：条件熵表示在已知随机变量X的条件下，随机变量Y的不确定性。将其定义为给定X的条件下Y的条件概率分布的熵对X的数学期望。其本质仍然是熵。其计算公式为

![条件熵计算公式](/FeilyZhang/ano/raw/master/images/tiaojianshang.png)
...
![信息增益计算公式](/FeilyZhang/ano/raw/master/images/information-gain.png)
